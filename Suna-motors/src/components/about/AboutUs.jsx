      ...
      <section className="relative h-[80vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <a
              href="/cars"
              className="px-14 py-6 bg-red-600 text-white font-bold text-xl rounded-full hover:bg-red-700 hover:scale-105 shadow-2xl transition-all duration-300"
            >
              Explore Inventory
            </a>
            <a
              href="/contact"
              className="px-14 py-6 bg-white/10 backdrop-blur-lg border-2 border-white text-white font-bold text-xl rounded-full hover:bg-white/20 transition-all duration-300"
            >
              Get in Touch
            </a>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                Founded in Migori with a passion for reliable mobility, Suna
                Motors Bazaar was created to solve real challenges in Kenya's
                car market — from hidden vehicle issues to unfair pricing and
                complicated logistics.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed mb-6">
                We partner exclusively with verified importers and local
                sellers, perform independent inspections, and provide complete
                documentation. Our goal: make premium car ownership accessible,
                safe, and enjoyable for every Kenyan.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed mb-8">
                From families in Nairobi to adventurers in the Rift Valley,
                we've proudly served thousands — earning trust one satisfied
                driver at a time.
              </p>
              <div className="flex items-center gap-6">
                <div className="flex -space-x-4">
                  ...
                  <img
                    ...
                    className="w-14 h-14 rounded-full border-4 border-white shadow"
                  />
                  <div className="w-14 h-14 rounded-full bg-red-600 border-4 border-white flex items-center justify-center text-white font-bold shadow">
                    +5K
                  </div>
                </div>
                <div>
                  ...
                  <p className="text-gray-600 font-medium">
                    Happy Nyanza and Migori Drivers
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-[1280px] mx-auto px-6 md:px-10 grid md:grid-cols-2 gap-16">
          <div className="bg-white rounded-3xl p-12 shadow-xl">
            <h3 className="text-3xl font-black mb-6 text-red-600">
              Our Vision
            </h3>
          ...
          <div className="bg-white rounded-3xl p-12 shadow-xl">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Deliver exceptional value through rigorous quality standards,
              complete transparency, nationwide accessibility, and outstanding
              customer care.
            </p>
          </div>
        </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-[1280px] mx-auto px-6 md:px-10 text-center">
          ...
          <p className="text-xl text-gray-600 mb-16 max-w-4xl mx-auto">
            The Suna Motors difference — built for Kenyan drivers
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="group bg-gray-50 rounded-3xl p-12 shadow-lg hover:shadow-2xl hover:-translate-y-6 transition-all duration-500">
              ...
              <p className="text-gray-600">
                150+ point mechanical & body inspection on every vehicle —
            ...
            <div className="group bg-gray-50 rounded-3xl p-12 shadow-lg hover:shadow-2xl hover:-translate-y-6 transition-all duration-500">
              ...
              <p className="text-gray-600">
                Full service history, accident reports, and fixed pricing — no
                surprises, ever.
              </p>
            </div>
            <div className="group bg-gray-50 rounded-3xl p-12 shadow-lg hover:shadow-2xl hover:-translate-y-6 transition-all duration-500">
              ...
              <p className="text-gray-600">
                Dedicated experts guide you from selection to registration,
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-10 grid md:grid-cols-2 gap-16">
          <div>
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              We promote fuel-efficient and low-emission vehicles, partner with
              eco-conscious importers, and encourage responsible car ownership
              for a greener Kenya.
            </p>
          </div>
          <div>
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              Proud supporters of road safety campaigns and local initiatives —
              because safe roads benefit every Kenyan family.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1280px] mx-auto px-6 md:px-10 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-12 opacity-70">
            ...
            <div className="text-2xl font-bold">
              Partnered with KCB & Equity Bank
            </div>
            ...
            <div className="group bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition">
              <div className="size-80 mx-auto rounded-3xl overflow-hidden mb-8">
                <div className="w-full h-full bg-gradient-to-br from-red-100 to-red-200 flex items-center justify-center">
                  <span className="material-symbols-outlined text-8xl text-red-600">
                    person
                  </span>
                </div>
              </div>
              ...
              <p className="text-gray-600">
                Visionary leader driving innovation in Kenya's automotive space
              </p>
            </div>
            <div className="group bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition">
              <div className="size-80 mx-auto rounded-3xl overflow-hidden mb-8">
              ...
              <p className="text-gray-600">
                Ensuring every client feels valued and supported
              </p>
            </div>
            <div className="group bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition">
              <div className="size-80 mx-auto rounded-3xl overflow-hidden mb-8">
              ...
              <p className="text-red-600 font-semibold mb-4">
                Vehicle Quality Director
              </p>
              <p className="text-gray-600">
                Overseeing rigorous standards for every car
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-20">
              {[
                ...
                },
                {
                  ...
                  desc: "Delivered our 1,000th vehicle and earned widespread trust",
                },
                {
                  year: "2025",
                  title: "Market Leader",
                ...
                >
                  ...
                  >
                    <div className="bg-gray-50 p-10 rounded-3xl shadow-2xl">
                      <p className="text-5xl font-black text-red-600 mb-3">
                        {milestone.year}
                      </p>
